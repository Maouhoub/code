...
class ModelPlain(ModelBase):
    ...
    def load(self):
        ...
        if load_path_G is not None:
            ...
            self.netG = self.load_network(load_path_G, self.netG, strict=self.opt_train['G_param_strict'], param_key='params',with_definition = self.opt_train['with_definition'])
